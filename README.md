  - [Русификатор для Kritika Global \<v1.10\>
    \[Shooran\#6186\]](#русификатор-для-kritika-global-v1.10-shooran6186)
      - [Установка](#установка)
...
## Русификатор для Kritika Global \<v1.10\> \[Shooran\#6186\]
...
### История версий
  ...
  - `v1.10`
      ...
      - Улучшение локализации (`FeniXkiller`)
