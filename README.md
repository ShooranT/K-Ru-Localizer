  - [Русификатор для Kritika Global \<v1.11\>
    \[Shooran\#6186\]](#русификатор-для-kritika-global-v1.11-shooran6186)
      - [Установка](#установка)
...
## Русификатор для Kritika Global \<v1.11\> \[Shooran\#6186\]

**Спасибо за помощь в работе над локализацией**: `MoonShi`, `SmO.Oke`

**Отдельное спасибо за идеи и улучшение перевода:** `FeniXkillah`
...
### Особенности перевода
  ...
  - Перевод делается автоматически на основе подготовленного русского
    перевода, по определённому алгоритму, никакого автоматического
    **перевода** (например, через Google Translate) **НЕ делается.**
...
### История версий
  ...
  - `v1.11`
      ...
      - Улучшение локализации (`FeniXkillah`)
  ...
  - `v1.8`
      ...
      - Добавлены ведущие пробелы для некоторых строк (`FeniXkillah`)
  ...
  - `v1.6`
      ...
      - Возвращены оригинальные комбинированные названия (например, для
        легендарных кристаллов) (`FeniXkillah`)
    
      - Возвращены оригинальные названия рейдов (`FeniXkillah`)
  ...
  - `v1.5`
      ...
      - добавлен перевод некоторых строк с корейского пока без
        возможности автообновления (`FeniXkillah`)
